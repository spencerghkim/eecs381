...
class Meeting {
  ...
  public:
    ...
    Meeting(int time_, const std::string& topic_, const Participants_c& participants_)
        : time{time_}, topic{topic_}, participants{participants_} {}
